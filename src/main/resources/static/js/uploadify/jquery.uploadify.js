    ...
    init: function(options, swfUploadOptions) {
      ...
      return this.each(function() {
        ...
        var settings = $.extend({
          ...
          successTimeout: 30, // The number of seconds to wait for Flash to detect the server's rsp after the file has finished uploading
        ...
        if (flashInstalled) {
          ...
          $button.html('<span class="uploadify-button-text"><i class="material-icons">file_upload</i>' + settings.buttonText + '</span>');
          // .css({
          //   'height': settings.height + 'px',
